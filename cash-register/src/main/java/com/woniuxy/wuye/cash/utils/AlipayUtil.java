...
import com.woniuxy.wuye.cash.config.PropertiesConfig;
...
public class AlipayUtil {
    public static String connect(AlipayBean alipayBean) throws AlipayApiException {
        ...
        //封装参数out_trade_no、product_code、total_amount、subject
        String out_trade_no = alipayBean.getOut_trade_no();/*"13213"*/;
        String total_amount =alipayBean.getTotal_amount() /*"1000"*/;
        String subject = alipayBean.getSubject()/*"Subject"*/;
        String body = alipayBean.getBody()/*"商品"*/;
